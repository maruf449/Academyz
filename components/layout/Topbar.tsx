...
const Topbar = () => {
  ...
  const topRoutes = [
    { label: "Create Course", path: "/instructor/courses" },
  ...
  return (
    <div className="flex justify-between items-center p-4 bg-orange-200">
      <Link href="/">
      ...
      <div className="flex gap-6 items-center">
        <div className="max-sm:hidden flex gap-6">
          {topRoutes.map((route) => (
            ...
            <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#009dff_0%,#FDAB04_50%,#009dff_100%)]" />
